...
if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
  message(FATAL_ERROR "Couldn't generate version.h file: .git repository was not found")
endif()
...
execute_process(
	  COMMAND touch src/version.h
	  WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR})

# Add command that is triggered again every time the git HEAD changes
add_custom_command(
OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/src/version.h
COMMAND cmake/generate-version.sh ${CMAKE_PROJECT_VERSION_MAJOR} ${CMAKE_PROJECT_VERSION_MINOR} ${CMAKE_PROJECT_VERSION_PATCH}
WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
DEPENDS ${GIT_DIR}/logs/HEAD
BYPRODUCTS src/version.h
VERBATIM)
